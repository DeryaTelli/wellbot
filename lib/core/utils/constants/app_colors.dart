...
class AppColors {
  ...
  static const LinearGradient backgroundGradient = LinearGradient(
    colors: [
      Color.fromARGB(255, 248, 166, 72),
      Color.fromARGB(255, 246, 171, 85),
      Color.fromARGB(255, 249, 147, 31),
    ],
    stops: [0.17, 0.25, 0.80],
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );
  static const Color lineColor = Color(0xB3EF9F27);
